...
# ----------------------------------------------------------------------------------------------------------------------
# Author:  KOTECKIS
# E-mail:  sergiusz.kotecki@zf.com
# Company: ZF Group
# Created: 07/12/2021
# ----------------------------------------------------------------------------------------------------------------------
# This  copyrighted  document is the property of ZF Friedrichshafen AG and its affiliates, including ZF Group Automotive
...
#                                     © ZF Friedrichshafen AG 07/12/2021.
# ----------------------------------------------------------------------------------------------------------------------
